...
func (t *testtxcacher) Only() bool {
	return true
}

func (t *testtxcacher) Set(id HashID, tx *TX) (*TX, error) {
	t.items[id] = tx
	return tx, nil
}
...
func (t *testtxcacher) Get(id HashID) (*TX, error) {
...
func NewTestFileCacher() TxCacher {
	return &testtxcacher{
		items:         map[HashID]*TX{},
